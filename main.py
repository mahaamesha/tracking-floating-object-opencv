...
def main():
    ...
    path2 = "E:/_TUGAS/_ITBOneDrive/OneDrive - Institut Teknologi Bandung/_Kuliah/_sem7/7_tugas akhir I/media/video-eksperimen/20-4.mp4"
    f.play_video(file_path=path2, process_func=f.processing_frame3)
